...
DsBiografia ='',
 ...
 DsSexo ='@10',
 DsEndereco ='@11',
 NroEndereco ='@12', DsComplemento ='@13',
 DsCEP ='@14', DsBairro ='@15', DsCidade ='@16', DsUF ='@1',
 UrlImage ='@18', DsUser ='@19' where  idProfissional = 5;
  ...
  update  profissional set   DsEmail='medeiros0441@gmail.com' where  idProfissional=27;
...
(
    ...
    [DataInicio] nvarchar(10) NOT NULL ,
    [DataFinal]  nvarchar(10) NOT NULL ,
...
"DELETE  FROM Experiencia WHERE IdExperiencia=1 and FKprofissional=27"
----------------------------------------------------------------------
...
(
    ...
    [DsDescricao] NVARCHAR (1000)  NULL, 
    [DsSexo] NVARCHAR (20)  NULL, 
    [Validade] NVARCHAR (20)  NULL, 
    [DataPublicacao] NVARCHAR (10)   NULL ,
 ...
 VALUES ('Médico Veterinário','No minimo 1 ano','CLT','responsável por cuidar e tratar bichos tanto de pequeno quanto de grande porte, 
 podendo atender animais domésticos,como gato e cachorro, e também os silvestres','Indiferente','1 Mês','06-02-2021',12);


 INSERT INTO [Vaga] VALUES ('Zootécnico','No minimo 1 ano','CLT','deve estar apto para planejar e coordenar a criação de bovinos, suínos, ovinos e aves','Indiferente','1 Mês','06-02-2021',12);
...
select * from Vaga  where FKCandidatos=
...
(
 ...
 select * from Empresa
 select * from Vaga
 select * from Candidatos,empresa,Profissional where  idprofissional =27 and idEmpresa= 2 and IdCandidatos=2 ;
insert  into Candidatos (idprofissional,DsData,FKVaga,idEmpresa) values (24,28/08/2000,1,2);
insert  into Candidatos (idprofissional,DsData,FKVaga,idEmpresa) values (24,28/08/2000,1,5);
