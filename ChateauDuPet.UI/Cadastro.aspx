...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
  ...
  <div class="col-md-2">
                        ...
                        <asp:TextBox runat="server" CssClass="form-control phone" ID="txtTelefone" AutoCompleteType="Office"  TabIndex="6" MaxLength="11" />
  ...
  <div class="col-md-3">
            ...
            <div class="col-md-3">
                        ...
                        <asp:TextBox runat="server"  CssClass="form-control senha" ID="senha" onblur="verificaForcaSenha()" TabIndex="9" TextMode="Password" />
                         <span id="SenhaRetorno"  onblur="verificaForcaSenha()">

                         </span><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="senha"  ErrorMessage="Campo Senha é obrigatório" ForeColor="red" />
  
                            </div> 
            <div class="col-md-3">  
                        <label id="lblSenhaa" class="form-label">Confirmar Senha *</label>
                        <asp:TextBox runat="server"   CssClass="form-control senhaC"   ID="senhaC"  onblur="validarSenha()" TabIndex="10" TextMode="Password" />
