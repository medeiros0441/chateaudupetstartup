<%@ Page Title="" Language="C#" MasterPageFile="~/DefultADM.Master" AutoEventWireup="true" CodeBehind="Perfil-Profissional-adm.aspx.cs" Inherits="ChateauDuPet.UI.Perfil_Profissional_adm" %>
                ...
                <div class="col-lg-8"> 
                        <div class="row g-2 gy-2">
                            ...
                            <div class="col-sm-10">
                                    ...
                                    <a   class="btn btn-outline-danger"     href="EditarPerfil.aspx">Atualizar</a>
                            </div>
                    ...
                    <asp:Repeater ID="rptCurso"  runat="server">
                        <ItemTemplate>
                            ...
                            <div class=" col-10">
                                ...
                                <div class=" col-2">
                                    <a  href="AddCertificados.aspx?id=<%# DataBinder.Eval(Container.DataItem, "IdCertificado") %>"> <asp:Image runat="server" Width="30" Height="30" ImageUrl="Imagens/icones/cursor.svg" /></a> 
                            </div>
                            </div>
                    ...
                    <asp:Repeater ID="rptExperiencia" runat="server">
                        <ItemTemplate>
                            ...
                            <div class="col-10">
                                ...
                                <div class=" col-2">
                                    <a  href="AddExperiencia.aspx?id=<%# DataBinder.Eval(Container.DataItem, "IdExperiencia") %>"> <asp:Image runat="server" Width="30" Height="30" ImageUrl="Imagens/icones/cursor.svg" /></a> 
                            </div>
                            </div>
    <hr class="featurette-divider">
